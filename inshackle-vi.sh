C #!/bin/bash
# Inshackle v1.0
# recoded by: Vibhansh Bamnia
# github.com https://github.com/vibhansh19/inshackle
# credit to cyber kallan $ xd20111
...
printf "      \e[1;31m[\e[0m\e[1;77mv1.0\e[0m\e[1;31m]\e[0m\e[1;77m recoded by Vibhansh Bamnia (thanks to linuxchoice )\e[0m\n"
}
